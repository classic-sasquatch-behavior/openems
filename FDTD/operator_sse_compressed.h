...
public:
	...
	vector<f4vector,aligned_allocator<f4vector, std::align_val_t {16}> > f4_vv_Compressed[3]; //!< coefficient: calc new voltage from old voltage
	vector<f4vector,aligned_allocator<f4vector, std::align_val_t {16}> > f4_vi_Compressed[3]; //!< coefficient: calc new voltage from old current
	vector<f4vector,aligned_allocator<f4vector, std::align_val_t {16}> > f4_iv_Compressed[3]; //!< coefficient: calc new current from old voltage
	vector<f4vector,aligned_allocator<f4vector, std::align_val_t {16}> > f4_ii_Compressed[3]; //!< coefficient: calc new current from old current
